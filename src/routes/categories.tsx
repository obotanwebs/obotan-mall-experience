        ...
        {CATEGORIES.map((c) => {
          ...
          return (
            <Link
              ...
              to="/categories/$slug"
              params={{ slug: c.slug }}
              className="group relative block aspect-[4/3] rounded-3xl overflow-hidden glass-strong cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/50"
            >
              <img
                src={IMG[c.slug]}
                alt={c.name}
              ...
              <div className="pointer-events-none absolute inset-x-6 bottom-6 text-white">
                ...
                <div className="mt-1 flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-1 text-sm font-semibold opacity-0 group-hover:opacity-100 transition">
